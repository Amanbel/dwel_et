...
export type TranslationKeys =
  ...
  | "exposureAnalytics"
  | "exposureAnalyticsDesc"
  | "contentExposureBreakdown"
  | "exportCsv"
  | "category"
  | "exposureTime"
  | "percentage"
  ...
  | "everythingInBase"
  | "includedInBase"
  | "advancedTrendAnalytics"
  | "pdfExportFunc"
  | "securePayment"
  | "recommendationsDesc"
  | "positiveTrends"
  | "focusBlocksImproving"
  | "vsLastWeek"
  | "suggestedAction"
  | "riskIndicator"
  | "lateNightScreenTime"
...
const translations: Record<Language, Record<TranslationKeys, string>> = {
  en: {
    ...
    dashboardNoAnalyticsDesc:
      "There is no wellness data available to display yet. Once sessions or browsing activity are recorded, your dashboard overview and charts will appear here.",
    dashboardWaitingForData: "Waiting for data",
    dashboardWaitingForDataDesc:
      "The dashboard loaded successfully, but the database returned no overview data for the selected period.",
    analytics: "Analytics",
    reports: "Reports",
  ...
  am: {
    ...
    dashboardNoAnalyticsDesc:
      "ለማሳየት የሚችል የደህንነት መረጃ እስካሁን የለም። ክፍለ ጊዜዎች ወይም የአሰሳ እንቅስቃሴ ከተመዘገቡ በኋላ የዳሽቦርድ አጠቃላይ እይታዎ እና ግራፎች እዚህ ይታያሉ።",
    dashboardWaitingForData: "መረጃ በመጠበቅ ላይ",
    dashboardWaitingForDataDesc:
      "ዳሽቦርዱ በትክክል ተጫኗል፣ ነገር ግን ዳታቤዙ ለተመረጠው ጊዜ የአጠቃላይ እይታ መረጃ አልመለሰም።",
    analytics: "ትንታኔ",
    reports: "ሪፖርቶች",
    sessions: "የአጠቃቀም መቃኛ",
    ...
    subscriptionDesc:
      "ለዲጂታል ደህንነት ምርምርዎ የሚፈለገውን የመረጃ ጥግግት እና ታሪካዊ ተደራሽነት ይምረጡ። በማንኛውም ጊዜ ማሳደግ ወይም መቀነስ ይችላሉ።",
    monthly: "በየወሩ",
    annually: "በየዓመቱ",
    ...
    recommendationsDesc:
      "በቅርብ ጊዜ የዲጂታል አጠቃቀምዎ ላይ በመመስረት፣ የእውቀት ጭነትዎን ለማመቻቸት እና ትኩረትን ለማሳደግ ቁልፍ ቦታዎችን ለይተናል። የእርስዎ ግላዊ የደህንነት ግንዛቤዎች እዚህ አሉ።",
    ...
    userToken: "የተጠቃሚ ማስመሰያ",
    saveChanges: "ለውጦችን አስቀምጥ",
    privacySettings: "የግላዊነት እና አርቴፊሻል ኢንተለጀንስ ቅንብሮች",
    localProcessing: "የአካባቢ ሂደት ብቻ",
    localProcessingDesc:
      "ሁሉንም የጽሑፍ እና የይዘት መለኪያዎች በአካባቢው በአሳሽ ውስጥ ይተንትኑ። ምንም የርቀት አገልጋዮች አይገናኙም።",
    allowSemantic: "ትርጉማዊ ማጠቃለያን ፍቀድ",
    allowSemanticDesc:
      "ከአሳሽ ክፍለ ጊዜዎች ጭብጦችን እና የርዕስ ደመናዎችን ለማውጣት የአካባቢ የኤንኤልፒ ትራንስፎርመሮችን ይጠቀሙ።",
    continuousLogging: "ቀጣይነት ያለው አውድ መመዝገብ",
    continuousLoggingDesc:
      "አካላዊ ድካምን (ዝቅተኛ/መካከለኛ/ከፍተኛ) ለመገመት ለንቁ ክፍለ ጊዜዎች የዐውደ-ጽሑፍ ቅጽበታዊ ገጽ እይታዎችን በራስ-ሰር ያንሱ።",
    dataPortability: "የመረጃ ተንቀሳቃሽነት",
    dataPortabilityDesc:
      "የታሪክ ምርምር መረጃዎን በማንኛውም ጊዜ ይላኩ። ወይም የአካባቢዎን የውሂብ ጎታ መዝገቦች በቋሚነት ያጥፉ።",
...
const textTranslations: Record<Language, Record<string, string>> = {
  ...
  am: {
    ...
    "Your highest cognitive engagement occurs between 09:00 and 11:30. Consider scheduling complex analysis during this period.":
      "ከፍተኛው የእውቀት ተሳትፎዎ ከጠዋቱ 3:00 እስከ 5:30 ባለው ጊዜ ውስጥ ይከሰታል። ውስብስብ ትንታኔዎችን በዚህ ጊዜ ውስጥ ለማቀድ ያስቡበት።",
    "You switched apps 42 times in the last hour of your session, correlating with a 15% drop in semantic depth.":
      "ባለፈው አንድ ሰዓት ውስጥ መተግበሪያዎችን 42 ጊዜ ቀያይረዋል፣ ይህም ከ15% የስራ ጥራት መቀነስ ጋር ይዛመዳል።",
    ...
    // Reports - Summaries
    "Your digital wellness score improved by 8% this week. Focus sessions were more sustained, and late-night screen time decreased significantly. The primary detractor remains context switching during peak productivity hours.":
      "በዚህ ሳምንት የዲጂታል ደህንነት ውጤትዎ በ8% አሻሽሏል። የትኩረት ክፍለ ጊዜዎች ይበልጥ የተረጋጉ ነበሩ፣ እና የሌሊት ስልክ/ኮምፒውተር አጠቃቀም በከፍተኛ ሁኔታ ቀንሷል። ዋናው እንቅፋት ግን በከፍተኛ ምርታማነት ሰዓታት ውስጥ መተግበሪያዎችን በተደጋጋሚ መቀያየርዎ ነው።",
    "Higher levels of notification disruptions were recorded. Screen time peaked during late evenings, leading to standard fatigue indicators. Deep work intervals were interrupted every 12 minutes on average.":
      "ከፍተኛ የማሳወቂያ ረብሻዎች ተመዝግበዋል። የስልክ/ኮምፒውተር አጠቃቀም በምሽት ከፍተኛ ደረጃ ላይ ደርሷል፣ ይህም ወደ መደበኛ የድካም ጠቋሚዎች ይመራል። የጥልቅ ሥራ ክፍለ ጊዜዎች በአማካይ በየ12 ደቂቃው ይቋረጡ ነበር።",
    ...
    "Data shows continued device usage right up to sleep time. Creating a buffer zone will improve sleep quality metrics.":
      "መረጃዎች እንደሚያሳዩት እስከ መኝታ ሰዓት ድረስ ያለማቋረጥ ስልክ/ኮምፒውተር ይጠቀማሉ። የማረፊያ ጊዜ መፍጠር የዕንቅልፍ ጥራት መለኪያዎችን ያሻሽላል።",
    "Batch Email Checking": "የኢሜይል ፍተሻን በቡድን ማድረግ",
    "You switched contexts to email 47 times during focus blocks. Try batching to 3 specific times daily.":
      "በትኩረት ሰዓታት ውስጥ ወደ ኢሜይል 47 ጊዜ ቀይረዋል። በቀን ወደ 3 የተወሰኑ ጊዜያት ለመቀነስ ይሞክሩ።",
    "Silence Social Notifications": "የማህበራዊ ማሳወቂያዎችን ጸጥ ያድርጉ",
    "Active distraction points occurred during high concentration blocks. Block non-essential notifications.":
      "በትኩረት ሰዓታት ውስጥ ንቁ የማዘናጊያ ነጥቦች ተከስተዋል። አስፈላጊ ያልሆኑ ማሳወቂያዎችን ያግዱ።",
    ...
    "Essential tools for individual awareness and daily tracking.":
      "ለግል ንቃተ-ህሊና እና ለዕለታዊ ክትትል አስፈላጊ መሣሪያዎች።",
    "Deep analytical tools and unlimited longitudinal data access.":
      "ጥልቅ የትንታኔ መሣሪያዎች እና ያልተገደበ የረጅም ጊዜ መረጃ መዳረሻ።",
